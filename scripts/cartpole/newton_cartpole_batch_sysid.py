...
from util import DYNAMIC_PARAM_NAMES, NONNEGATIVE_PARAM_NAMES, PARAM_SPECS, POLE_BODY_INDEX, POLE_TIP_LOCAL, URDF_PATH
...
def evaluate_population_batched(
    *,
    ...
    batch = evaluate_world_batch(
        ...
        dt=dt,
        tip_body_index=POLE_BODY_INDEX,
        tip_local=POLE_TIP_LOCAL,
    )
            ...
            "snippets": [
                {
                    ...
                    "start_step": snippet.start_step,
                    "end_step": snippet.end_step,
                    "start_time": float(snippet.start_step * dt),
                    "end_time": float(snippet.end_step * dt),
